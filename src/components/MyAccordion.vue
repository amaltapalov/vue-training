  ...
  <div class="container">
    <div id="media-list">
      ...
      <select v-on:change="filterList">
        ...
        <option v-for="media in uniqueListItem" :key="media">{{media}}</option>
      </select>
      <ul>
        <!-- v-show below works with filterList method -->
        <li
...
export default {
  ...
  methods: {
    ...
    filterList: function() {
      // look at data - type: ""
      // we added a new data as type to call it in filterList method
      this.type = event.target.value;
    }
  },
  computed: {
    uniqueListItem: function() {
      const types = [];
